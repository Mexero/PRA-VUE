    ...
    <main>
        ...
        <section id="infoBloque">
            ...
            <article class="descargaPDF" id="inicioRapido">
                ...
                <div class="PDFlinks">
                    <a href="https://mega.nz/file/zrZllYDS#WAAOa49v1Sgwcikk3KUBhCmOqYxi0KWMyw3mgMxICzY" target="_blank">
                        <div>PDF Resumen del sistema</div>
                    </a>
                    <a href="https://mega.nz/file/X3pXQSTC#0IdzJJkiJBDGHEjIVFP6vFOsITsjXauo4HvFqqkJ8TY" target="_blank">
            ...
            <article class="descargaPDF" id="descargaLibro">
                ...
                <div class="PDFlinks">
                    <a href="https://mega.nz/file/6mACjaxT#qFzwanQCyEXhsR4KYVBskqbNfEvj1cZVR_9Nv20jr50" target="_blank">
                        <div>PDF Base</div>
                    </a>
...
Son 2 filas de 2 parejas de bloques cada uno que se acomodan segun el tamaño de la pagina */
.filaMenuPlayer,
.pareja {
    display: flex;
    flex-wrap: wrap;
...
.bloque:hover .textoBloqueG,
.bloque:hover .textoBloque {
    transition: all 0.3s ease-out;
    font-weight: 500;
}
...
/* ======================= MODO MOVIL DEL SECTION MENU DEL INDEX ======================= 
solo cambia el tamaños de los bloques y el margen con el header*/
