...
function toggleModo() {
    ...
    root.style.setProperty('--color-principal1', oscuro.value ? '#8d0530' : '#94c4ff')
    ...
    root.style.setProperty('--color-tabla1', oscuro.value ? '#7d2929' : '#a3cdff')
    root.style.setProperty('--color-tabla2', oscuro.value ? '#a03434' : '#bae2ff')
